...
# Bootloader"
TARGET_BOOTLOADER_BOARD_NAME := RILRL28A003

# File systems
BOARD_HAS_LARGE_FILESYSTEM := true
#BOARD_RECOVERYIMAGE_PARTITION_SIZE := 72744960 # This is the maximum known partition size, but it can be higher, so we just omit it
